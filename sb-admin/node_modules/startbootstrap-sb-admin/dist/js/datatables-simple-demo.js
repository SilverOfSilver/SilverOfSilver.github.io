...
document.getElementById("ageRangeForm").addEventListener("submit", function (event) {
    ...
    if (entryCount === 0) {
        ...
        document.getElementById("ftEntry").textContent = "No user found";
        return;
    }
    
    document.getElementById("ftEntry").innerHTML = "Name: "+filteredData[i%entryCount].name+"<br>";
    document.getElementById("ftEntry").innerHTML += "Position: "+filteredData[i%entryCount].position+"<br>";
    document.getElementById("ftEntry").innerHTML += "Office: "+filteredData[i%entryCount].office+"<br>";
    document.getElementById("ftEntry").innerHTML += "Age: "+filteredData[i%entryCount].age+"<br>";
    document.getElementById("ftEntry").innerHTML += "Start Date: "+filteredData[i%entryCount].startDate+"<br>";
    document.getElementById("ftEntry").innerHTML += "Salary: "+filteredData[i%entryCount].salary;
